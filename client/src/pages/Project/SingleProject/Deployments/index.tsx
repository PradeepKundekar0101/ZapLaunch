      ...
      <div className=" text-white p-4 rounded-lg relative ">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-2 text-sm text-gray-400">
            ...
            {deployments && deployments?.length > 0 && <a className="text-sm flex items-center" target="_blank" href={`https://${project.projectName}.getbuild.io`}><span className={`flex items-center ${currentDeploymentStatus == "DEPLOYED" || deployments?.length > 0 && deployments[0].status === "DEPLOYED" && "text-green-400"}`}>
